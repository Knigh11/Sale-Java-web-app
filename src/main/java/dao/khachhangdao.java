...
public class khachhangdao {
  ArrayList<khachhangbean> dskhachhang = null;

  public ArrayList<khachhangbean> getdskhachhang() throws SQLException{
      dskhachhang = new ArrayList<khachhangbean>();
      // b1: ket noi vao csdl
  ...
  public int ThemKhachHang(String hoten, String diachi, String email, String tendangnhap,
