...
<div class="dk" style="margin: 0 auto;">
  ...
  <div  class="container">
    ...
    <input type="text" placeholder="Họ tên" name="fullname" id="email" required>
    ...
    <input type="text" placeholder="username" name="tk" id="tk" required>

    <label for="psw"><b>Password</b></label>
    <input type="password" placeholder="Enter Password" name="password" id="psw" required>

    <label for="psw"><b>Repeat Password</b></label>
    <input type="password" placeholder="Repeat Password" name="password2" id="psw" required>
    

    <hr>

    <button style="background: darkorange" type="submit" class="registerbtn">Register</button>
  </div>
</form>
